export const flamelingABI = [
  {
    inputs: [
      ...
      { internalType: "uint16[6]", name: "feeSettings", type: "uint16[6]" },
      {
        internalType: "uint256",
        name: "minimumTokenBalanceForDividends_",
        type: "uint256",
      },
      { internalType: "uint8", name: "_tokenForMarketingFee", type: "uint8" },
    ],
  ...
  },
  {
    inputs: [],
    name: "feeContract",
    outputs: [{ internalType: "contract IFee", name: "", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  {
    inputs: [],
    name: "uniswapV2Caller",
    outputs: [
      { internalType: "contract IUniswapV2Caller", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [
      { internalType: "uint16", name: "_sellLiquidityFee", type: "uint16" },
      { internalType: "uint16", name: "_buyLiquidityFee", type: "uint16" },
    ],
    name: "updateLiquidityFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "uint16", name: "_sellMarketingFee", type: "uint16" },
      { internalType: "uint16", name: "_buyMarketingFee", type: "uint16" },
    ],
    name: "updateMarketingFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "uint256", name: "_maxWallet", type: "uint256" }],
    name: "updateMaxWallet",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [
      { internalType: "uint16", name: "_sellRewardFee", type: "uint16" },
      { internalType: "uint16", name: "_buyRewardFee", type: "uint16" },
    ],
    name: "updateRewardFee",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "_baseTokenForPair", type: "address" },
    ],
