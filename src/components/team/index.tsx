    ...
    return (
        <div className="flex flex-col h-full max-w-[500px] w-full mx-auto justify-center bg-white/10 p-8 rounded-3xl border-2 border-highlight text-center">
            ...
            <Image
                src={img}
                alt={name}
                className="overflow-hidden rounded-xl p-1 mx-auto my-4 h-60 w-auto"
                width={40}
                height={40}
                priority
            />
            <div className="flex flex-col justify-center my-4 max-w-64 2xl:max-w-none mx-auto">
            ...
            <div className="flex flex-col justify-center my-4 max-w-64 xxl:max-w-none mx-auto">
